...
public class C_ConsultorioMedico {
    ...
    public int cantidadEmbarazadasDiabeticas(){
        ...
        for (int i =0;i<embarazadasArrayList.size();i++ ){
            if (embarazadasArrayList.get(i) instanceof C_EmbarazadaDiabeticaDiabetica){
                cantidadDiabeticas++;
            }
        }
    ...
    public void imprimirValorChequeoExtra(){
        for (int i=0; i< embarazadasArrayList.size();i++){
            if (embarazadasArrayList.get(i) instanceof C_EmbarazadaDiabeticaDiabetica || embarazadasArrayList.get(i) instanceof C_EmbarazadaTensionAlta){
